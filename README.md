...
Batch script which appends videos via avidemux

## Usage
Create a list of videos that you want to be appended with the names {name}1, {name}2, {name}3, etc.

Run ./AppendToMP4.bat {name}, or Run ./AppendToMP4.bat and type in the name when prompted.
This will output the appended video to {name}.

Example: video1.mkv, video2.mvk, video3.mkv, run with ./AppendToMP4.bat video.mkv
